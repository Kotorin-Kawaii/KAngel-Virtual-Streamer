...
from core.stream_schedule import StreamScheduleService
from core.daily_theme import DailyThemeService
from core.streamer_activity import StreamerActivityService, StreamerActivityState
...
class StreamMetadataPusher:
    ...
    def _maybe_evaluate_activity(self, theme_id: str) -> None:
        ...
        from core.event_bus import persona_event_pipeline
